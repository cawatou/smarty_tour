...
Общая стоимость тура: {$data.model->getPrice()|price_format:true} р.
...
Для завершения покупки, необходимо перейти по ссылке ниже, ознакомиться с договором и внести предоплату:
{$data.model->getUrl()}
