                        ...
                        <table class="table table-responsive table-striped stupidtable">
                            ...
                            <tr{if in_array($i.name, $backlight)} class="warning"{/if} {if $i.type == 'DIR'}data-fs-value="dir"{else}data-fs-value="file"{/if}>
                                ...
                                <td data-sort-value="{$i.file_name|escape}">
                                    {if $i.is_img}<i class="fa fa-picture-o"></i>{else}<i class="fa fa-file-o"></i>{/if} {$i.file_name|escape|truncate:50:"…":true}
                                    {if $i.is_img}
                                ...
                                <td class="right nowrap">
                                    {if $i.type == 'FILE'}
                                        <a href="{$i.url}" class="btn btn-xs btn-primary blank" title="{'Скачать файл'|t}"><i class="fa fa-download"></i></a>
                                    {/if}
