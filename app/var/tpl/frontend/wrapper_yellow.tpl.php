...
<html lang="RU">
    <head>
        ...
        <link href="{$__url->css('/frontend/base_style_yellow.css')}?{$v}" rel="stylesheet" media="all" />
            ...
            <div id="header">
                <div class="header-logo-l">
                    <a href="{$__url->main()}" title="На главную" style="display: block; position: relative;">
                        <img src="{$__url->img('/frontend/logo_red.gif')}" alt="Логотип" />
                        <img src="{$__url->img('/frontend/logo_yellow_suffix.gif')}" alt="Логотип" style="position: absolute; right: 15px;" />
                    </a>
                </div>
